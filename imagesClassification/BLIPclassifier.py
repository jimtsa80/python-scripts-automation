...
def classify_and_move_image(processor, model, image_path, ads_folder, keywords, csv_file):
    try:
        ...
        if caption:
            ...
            save_to_csv(filename, caption, ocr_text_sanitized, csv_file)
        else:
        ...
        for filename in os.listdir(input_folder):
            ...
            if os.path.isfile(file_path):
                futures.append(executor.submit(
                    classify_and_move_image, processor, model, file_path, ads_folder, keywords, csv_file))
