...
$sourceUrl = "https://isieve.blob.core.windows.net/snapstream/*?sv=2022-11-02&ss=b&srt=sco&sp=rwdlaciytfx&se=2099-09-05T22:45:03Z&st=2024-05-16T14:45:03Z&spr=https&sig=yVBZ2bDqiv%2BcsRyvHXfH1SPlvNoUM0fzu3qCmiavjVc%3D";
$destinationPath = "F:\downloads\batch23";
$pythonScriptPath = "C:\Users\jimtsa\Desktop\python-scripts-automation\imagesSimilarity\run_lite_new.ps1"
$logFile = "F:\downloads\task_log.txt"
...
try {
    #$azCopyCommand = "azcopy copy '$sourceUrl' '$destinationPath' --include-pattern '*12807*' --recursive=True"
    $azCopyCommand = "azcopy copy '$sourceUrl' '$destinationPath' --list-of-files 'filelist.txt' --recursive=True"
...
try {
    ...
    $scriptExecutionCommand = "powershell -NoProfile -ExecutionPolicy Bypass -File `"$pythonScriptPath`" `"$destinationPath`" -mode simple -threshold 0.99 -clusters 10"
